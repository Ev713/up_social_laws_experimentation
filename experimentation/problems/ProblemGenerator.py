...
class MarketTraderGenerator(NumericProblemGenerator):
    def generate_problem(self, file_name, sl=False):
        ...
        self.problem.ma_environment.add_fluent(drive_cost)
        self.problem.ma_environment.add_fluent(price)
        self.problem.ma_environment.add_fluent(sellprice)
        ...
        for a in self.problem.agents:
            a.add_fluent(at)
            a.add_fluent(can_drive)
            a.add_fluent(bought)
            a.add_fluent(cash)
            a.add_fluent(capacity)
            a.add_action(travel)
            a.add_action(buy)
