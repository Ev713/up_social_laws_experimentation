...
The benchmark suite spans nine domains:
\texttt{driverlog},
\texttt{grid},
\texttt{intersection},
...
\texttt{zenotravel}.
Most domains were evaluated both with and without a social law; \texttt{numeric\_markettrader} appears only without a social law in this run. Most domain/setting combinations contain 20 instances; \texttt{numeric\_expedition} contains 21 because the suite also includes a minimal instance.
